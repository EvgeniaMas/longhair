/**
 * Created by gennadii on 06.06.2016.
 */
...
var buyed = function (cnr) {
 var timeInterval = setTimeout(function tInterval() {
  ...
  else if (typeof man !== 'undefined' && man == 1) {
   var id = 'man';
  }
  else {
   var randomArray = ['woman', 'man'];
   var id = randomArray[Math.floor(Math.random() * randomArray.length)];
  }
